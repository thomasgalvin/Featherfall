...
class SQLiteAuditDB( databaseFile: File,
    ...
    private val sqlCreateTableSystemInfo = loadSql("/galvin/ff/db/sqlite/audit/create_table_system_info.sql")
    private val sqlCreateTableSystemInfoNetworks = loadSql("/galvin/ff/db/sqlite/audit/create_table_system_info_networks.sql")
    private val sqlStoreSystemInfo = loadSql("/galvin/ff/db/sqlite/audit/store_system_info.sql")
    private val sqlStoreSystemInfoNetwork = loadSql("/galvin/ff/db/sqlite/audit/store_system_info_network.sql")
    private val sqlRetrieveAllSystemInfo = loadSql("/galvin/ff/db/sqlite/audit/retrieve_all_system_info.sql")
    private val sqlRetrieveSystemInfoByUuid = loadSql("/galvin/ff/db/sqlite/audit/retrieve_system_info_by_uuid.sql")
    private val sqlRetrieveSystemInfoNetworks = loadSql("/galvin/ff/db/sqlite/audit/retrieve_system_info_networks.sql")

    private val sqlCreateTableAccessInfo = loadSql("/galvin/ff/db/sqlite/audit/create_table_access_info.sql")
    private val sqlCreateTableAccessInfoMods = loadSql("/galvin/ff/db/sqlite/audit/create_table_access_info_mods.sql")

    private val sqlStoreAccessInfo = loadSql("/galvin/ff/db/sqlite/audit/store_access_info.sql")
    private val sqlStoreAccessInfoMod = loadSql("/galvin/ff/db/sqlite/audit/store_access_info_mod.sql")

    private val sqlRetrieveAccessInfoMods = loadSql("/galvin/ff/db/sqlite/audit/retrieve_access_info_mods.sql")
    
    private val sqlCreateTableCurrentSystemInfo = loadSql("/galvin/ff/db/sqlite/audit/create_table_current_system_info.sql")
    private val sqlDeleteCurrentSystemInfo = loadSql("/galvin/ff/db/sqlite/audit/delete_current_system_info.sql")
    private val sqlSetCurrentSystemInfo = loadSql("/galvin/ff/db/sqlite/audit/store_current_system_info.sql")
    private val sqlRetrieveCurrentSystemInfo = loadSql("/galvin/ff/db/sqlite/audit/retrieve_current_system_info.sql")
    private val sqlCurrentSystemInfoExistsByUuid = loadSql("/galvin/ff/db/sqlite/audit/current_system_info_exists_by_uuid.sql")
