...
class SQLiteUserDB( databaseFile: File) : UserDB, SQLiteDB(databaseFile) {
    ...
    private val sqlCreateTableRoles = loadSql("/galvin/ff/db/sqlite/roles/create_table_roles.sql")
    private val sqlCreateTableRolePermissions = loadSql("/galvin/ff/db/sqlite/roles/create_table_role_permissions.sql")
    private val sqlCreateTableUsers = loadSql("/galvin/ff/db/sqlite/users/create_table_users.sql")
    private val sqlCreateTableContactInfo = loadSql("/galvin/ff/db/sqlite/users/create_table_contact_info.sql")
    private val sqlCreateTableUserRoles = loadSql("/galvin/ff/db/sqlite/users/create_table_user_roles.sql")

    private val sqlDeleteRole = loadSql("/galvin/ff/db/sqlite/roles/delete_role.sql")
    private val sqlDeleteRolePermissions = loadSql("/galvin/ff/db/sqlite/roles/delete_role_permissions.sql")

    private val sqlStoreRole = loadSql("/galvin/ff/db/sqlite/roles/store_role.sql")
    private val sqlStoreRolePermission = loadSql("/galvin/ff/db/sqlite/roles/store_role_permission.sql")
    private val sqlRetrieveAllRoles = loadSql("/galvin/ff/db/sqlite/roles/retrieve_all_roles.sql")
    private val sqlRetrieveRoleByUuid = loadSql("/galvin/ff/db/sqlite/roles/retrieve_role_by_uuid.sql")
    private val sqlRetrieveRolePermissions = loadSql("/galvin/ff/db/sqlite/roles/retrieve_role_permissions.sql")

    private val sqlSetRoleActive = loadSql("/galvin/ff/db/sqlite/roles/set_role_active.sql")

    private val sqlStoreUser = loadSql("/galvin/ff/db/sqlite/users/store_user.sql")
    private val sqlStoreUserContactInfo = loadSql("/galvin/ff/db/sqlite/users/store_user_contact_info.sql")
    private val sqlStoreUserRole = loadSql("/galvin/ff/db/sqlite/users/store_user_roles.sql")

    private val sqlUserExistsByUuid = loadSql("/galvin/ff/db/sqlite/users/user_exists_by_uuid.sql")
    private val sqlRetrieveUserByUuid = loadSql("/galvin/ff/db/sqlite/users/retrieve_user_by_uuid.sql")
    private val sqlRetrieveUserBySerialNumber = loadSql("/galvin/ff/db/sqlite/users/retrieve_user_by_serial_number.sql")
    private val sqlRetrieveUserByLogin= loadSql("/galvin/ff/db/sqlite/users/retrieve_user_by_login.sql")
    private val sqlRetrieveAllUsers = loadSql("/galvin/ff/db/sqlite/users/retrieve_all_users.sql")

    private val sqlRetrieveContactInfoForUser = loadSql("/galvin/ff/db/sqlite/users/retrieve_contact_info_for_user.sql")
    private val sqlRetrieveRolesForUser = loadSql("/galvin/ff/db/sqlite/users/retrieve_roles_for_user.sql")

    private val sqlRetrieveUuidByLogin = loadSql("/galvin/ff/db/sqlite/users/retrieve_uuid_by_login.sql")
    private val sqlRetrieveUuidBySerialNumber = loadSql("/galvin/ff/db/sqlite/users/retrieve_uuid_by_serial_number.sql")

    private val sqlRetrieveUsersByLocked = loadSql("/galvin/ff/db/sqlite/users/retrieve_users_by_locked.sql")
    private val sqlSetLockedByUuid = loadSql("/galvin/ff/db/sqlite/users/set_locked_by_uuid.sql")
    private val sqlSetLockedByLogin = loadSql("/galvin/ff/db/sqlite/users/set_locked_by_login.sql")
    private val sqlIsLockedByUuid = loadSql("/galvin/ff/db/sqlite/users/is_locked_by_uuid.sql")
    private val sqlIsLockedByLogin = loadSql("/galvin/ff/db/sqlite/users/is_locked_by_login.sql")

    private val sqlRetrieveUsersByActive = loadSql("/galvin/ff/db/sqlite/users/retrieve_users_by_active.sql")
    private val sqlSetActiveByUuid = loadSql("/galvin/ff/db/sqlite/users/set_active_by_uuid.sql")
    private val sqlSetActiveByLogin = loadSql("/galvin/ff/db/sqlite/users/set_active_by_login.sql")
    private val sqlIsActiveByUuid = loadSql("/galvin/ff/db/sqlite/users/is_active_by_uuid.sql")
    private val sqlIsActiveByLogin = loadSql("/galvin/ff/db/sqlite/users/is_active_by_login.sql")

    private val sqlDeleteContactInfoForUser = loadSql("/galvin/ff/db/sqlite/users/delete_contact_info_for_user.sql")
    private val sqlDeleteRolesForUser = loadSql("/galvin/ff/db/sqlite/users/delete_roles_for_user.sql")

    private val sqlSetPasswordByUuid = loadSql("/galvin/ff/db/sqlite/users/set_password_by_uuid.sql")
    private val sqlSetPasswordByLogin = loadSql("/galvin/ff/db/sqlite/users/set_password_by_login.sql")
    private val sqlRetrievePasswordHashByUuid = loadSql("/galvin/ff/db/sqlite/users/get_password_hash_by_uuid.sql")

    private val sqlUpdateCredentialsByUuid = loadSql("/galvin/ff/db/sqlite/users/update_credentials_by_uuid.sql")
    private val sqlRetrieveCredentialsByUuid = loadSql("/galvin/ff/db/sqlite/users/retrieve_credentials_by_uuid.sql")
